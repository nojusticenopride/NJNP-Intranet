...
const columns = [
  ...
  { label: 'Status', field: 'expense_status',    defaultValue: 'Pending',
    ...
    inputType: 'select',  width: 100, editable: false,},
...
'Roll-Over : Income - Roll-Over'],
 ...
 { label: 'Urgency', field: 'urgency'},
  { label: 'Approved by', field: 'approver_name', width:80, editable: false}
];
...
const loadData = () => {
  ...
  fetch('https://njnpcommunity.org/wp-json/njnp-json/v1/my-expenses')
...
table.addEventListener('updateEntry.mdb.tableEditor', (e) => {
  ...
  const { id, expense_status, category, amount, vendor, receipt_date, account_number, urgency,notes } = e.row;
